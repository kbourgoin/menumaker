...
describe("DishCard", () => {
  ...
  it("returns null for invalid dish object", () => {
    ...
    const { container } = render(
      <DishCard dish={null as unknown as typeof mockDish} />
    );
    expect(
      container.querySelector('[data-testid="mock-auth-provider"]')
    ).toBeInTheDocument();
    expect(
      container.querySelector('[data-testid="dish-card-header"]')
    ...
    expect(
      container2.querySelector('[data-testid="mock-auth-provider"]')
    ).toBeInTheDocument();
    expect(
      container2.querySelector('[data-testid="dish-card-header"]')
    ).not.toBeInTheDocument();
  });
