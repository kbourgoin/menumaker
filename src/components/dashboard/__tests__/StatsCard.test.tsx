...
describe('StatsCard', () => {
  ...
  it('should render loading state', () => {
    render(
      <StatsCard stats={null} isLoading={true} />,
  ...
  it('should render empty state when no stats available', () => {
    render(
      <StatsCard stats={null} isLoading={false} />,
      { wrapper: createWrapper }
    )

    expect(screen.getByText('No stats available yet.')).toBeInTheDocument()
    expect(screen.getByText('Add some dishes to see your stats!')).toBeInTheDocument()
  })
  ...
  it('should handle stats with no top dishes', () => {
    ...
    render(
      <StatsCard stats={statsWithoutTopDishes} isLoading={false} />,
      { wrapper: createWrapper }
    )
  ...
  it('should handle stats with no cuisines', () => {
    ...
    render(
      <StatsCard stats={statsWithoutCuisines} isLoading={false} />,
      { wrapper: createWrapper }
    )
  ...
  it('should filter out cuisines with zero counts', () => {
    ...
    render(
      <StatsCard stats={statsWithZeroCounts} isLoading={false} />,
      { wrapper: createWrapper }
    )
  ...
  it('should sort cuisines by count in descending order', () => {
    ...
    render(
      <StatsCard stats={statsWithUnsortedCuisines} isLoading={false} />,
      { wrapper: createWrapper }
    )

    const cuisineElements = screen.getAllByRole('button').filter(btn => 
      ['Italian', 'Mexican', 'Indian', 'American'].includes(btn.textContent || '')
    )
  ...
  it('should handle edge case of single cuisine', () => {
    ...
    render(
      <StatsCard stats={statsWithSingleCuisine} isLoading={false} />,
      { wrapper: createWrapper }
    )
