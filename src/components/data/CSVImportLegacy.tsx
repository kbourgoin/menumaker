...
interface CSVImportLegacyProps {
  onImportComplete?: () => void;
}

const CSVImportLegacy = ({ onImportComplete }: CSVImportLegacyProps) => {
    ...
    <>
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="sm:max-w-lg">
          <DialogHeader>
            <DialogTitle>Import Meal History from CSV (Legacy)</DialogTitle>
            <DialogDescription>
...
export default CSVImportLegacy;
