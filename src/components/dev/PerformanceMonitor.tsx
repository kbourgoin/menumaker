    ...
    <div className="fixed bottom-4 right-4 bg-black/90 text-white p-3 rounded-lg text-xs font-mono z-50 min-w-64">
      ...
      <div className="space-y-1">
        ...
        <div className="flex justify-between">
          ...
          <span className={stats.successRate >= 95 ? "text-green-400" : "text-yellow-400"}>
        ...
        <div className="flex justify-between">
          ...
          <span className={stats.fallbackRate <= 5 ? "text-green-400" : "text-red-400"}>
        ...
        <div className="flex justify-between">
          ...
          <span className={stats.averageDuration <= 500 ? "text-green-400" : 
                           stats.averageDuration <= 1000 ? "text-yellow-400" : "text-red-400"}>
        ...
        <div className="flex justify-between">
          ...
          <span className={stats.maxDuration <= 1000 ? "text-green-400" : 
                           stats.maxDuration <= 2000 ? "text-yellow-400" : "text-red-400"}>
        ...
        <div className="flex justify-between">
          ...
          <span className={stats.slowQueries === 0 ? "text-green-400" : "text-red-400"}>
            {stats.slowQueries}
          </span>
        </div>
      </div>
