...
export const getPageSEO = (page: string, data?: { dishName?: string }) => {
  ...
  switch (page) {
    case 'home':
      ...
      seoData.description = 'Track your family meals, discover new recipes, and keep a history of your culinary adventures with MenuMaker.';
      break;
      
    case 'all-meals':
      seoData.title = 'All Dishes - MenuMaker';
      seoData.description = 'Browse and manage all your family dishes and recipes in one place.';
      break;
    ...
    case 'weekly-menu':
      ...
      seoData.description = 'Plan your weekly meals with AI-powered suggestions based on your cooking history.';
      break;
