      ...
      <div className="max-w-5xl mx-auto">
                    ...
                    <div className="flex-1 p-4">
                      {dish ? (
                        <div className="relative">
                          ...
                          >
                            <RefreshCw
                              className={`h-4 w-4 ${refreshingDayIndex === index ? "animate-spin" : ""}`}
                            />
                          </Button>
                        </div>
                      ) : (
        ...
        <div className="mt-8 text-center animate-fade-in delay-200">
          <p className="text-sm text-muted-foreground mb-4">
            This weekly menu is intelligently generated based on your meal
            history, frequency of cooking, and variety of cuisines. It
            prioritizes dishes you enjoy but haven't made recently.
          </p>
          <Button
            onClick={generateWeeklyMenu}
            className="bg-terracotta-500 hover:bg-terracotta-600"
            disabled={
              isLoading || !allDishes || allDishes.length === 0 || isGenerating
            }
          >
            <Shuffle className="mr-2 h-4 w-4" />
