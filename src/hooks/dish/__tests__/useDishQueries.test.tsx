...
describe('useDishQueries', () => {
  ...
  describe('error handling and fallback', () => {
    it('should handle authentication errors', async () => {
      ...
      expect(logError).toHaveBeenCalledWith(expect.any(Object), 'useDishQueries:auth')
    })
    ...
    it('should fallback to original method when materialized view fails', async () => {
      ...
      expect(logError).toHaveBeenCalledWith(expect.any(Object), 'useDishQueries:view-failed')
    })
    ...
    it('should handle both view and fallback failures gracefully', async () => {
      ...
      vi.mocked(fetchDishesOriginalMethod).mockRejectedValue(new Error('Fallback error'))
      ...
      expect(result.current.dishes).toEqual([])
      expect(logError).toHaveBeenCalledWith(expect.any(Object), 'useDishQueries:view-failed')
      expect(logError).toHaveBeenCalledWith(expect.any(Object), 'useDishQueries:fallback-failed')
    })
  })
  ...
  describe('performance monitoring', () => {
    it('should track query performance metrics', async () => {
      ...
      expect(measureAsync).toHaveBeenCalledWith('dishes-query', expect.any(Function))
      expect(measureAsync).toHaveBeenCalledWith('dishes-summary-view', expect.any(Function))
      expect(trackQuery).toHaveBeenCalledWith(expect.objectContaining({
