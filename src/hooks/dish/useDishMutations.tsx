...
export function useDishMutations() {
  ...
  const addDishMutation = useMutation({
    mutationFn: async (dish: Omit<Dish, "id" | "createdAt" | "timesCooked" | "user_id">) => {
      try {
        ...
        if (!dish.name?.trim()) {
          const validationError = classifyError(new Error("Dish name is required"));
  ...
  return {
    ...
    addDishError: addDishMutation.error ? classifyError(addDishMutation.error) : null,
    updateDishError: updateDishMutation.error ? classifyError(updateDishMutation.error) : null,
    deleteDishError: deleteDishMutation.error ? classifyError(deleteDishMutation.error) : null,
