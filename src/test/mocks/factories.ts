...
export const createMockMealHistory = (
...
export const createMockDBSource = (
  overrides: Partial<DBSource> = {}
): DBSource => ({
  id: "test-source-1",
  name: "Test Cookbook",
  type: "book",
...
export const createMockDBMealHistory = (
  overrides: Partial<DBMealHistory> = {}
): DBMealHistory => ({
  id: "test-history-1",
  dishid: "test-dish-1",
  date: "2024-01-15T00:00:00Z",
...
export const createMockDBProfile = (
  overrides: Partial<DBProfile> = {}
): DBProfile => ({
  id: "test-user-1",
  username: "testuser",
...
export const createMockDishes = (count: number = 3): Dish[] => {
  return Array.from({ length: count }, (_, index) =>
    createMockDish({
      ...
      cuisines: ["Italian", "Mexican", "Asian"][index % 3]
        ? [["Italian", "Mexican", "Asian"][index % 3]]
        : ["Italian"],
      timesCooked: index + 1,
...
export const createMockMealHistoryEntries = (
  dishId: string,
  count: number = 3
): MealHistory[] => {
  return Array.from({ length: count }, (_, index) =>
...
export const createMockAuthError = () =>
  createMockError("Authentication failed", "AUTH_ERROR");
export const createMockNetworkError = () =>
  createMockError("Network request failed", "NETWORK_ERROR");
export const createMockValidationError = () =>
  createMockError("Validation failed", "VALIDATION_ERROR");
