...
import { mapMealHistoryFromDB, mapMealHistoryToDB } from '../mealHistoryMappers'
...
describe('mealHistoryMappers', () => {
  ...
  describe('mapMealHistoryToDB', () => {
    ...
    it('should throw error when dishId is missing for new meal history', () => {
      ...
      expect(() => mapMealHistoryToDB(historyWithoutDishId)).toThrow('DishId is required when creating a new meal history record')
    })
