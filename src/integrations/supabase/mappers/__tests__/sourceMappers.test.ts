...
import { mapSourceFromDB, mapSourceToDB, type DBSource } from '../sourceMappers'
...
describe('sourceMappers', () => {
  ...
  describe('mapSourceToDB', () => {
    ...
    it('should throw error when name is missing for new source', () => {
      ...
      expect(() => mapSourceToDB(sourceWithoutName)).toThrow('Name is required when creating a new source')
    })
    ...
    it('should throw error when type is missing for new source', () => {
      ...
      expect(() => mapSourceToDB(sourceWithoutType)).toThrow('Type is required when creating a new source')
    })
